          ...
          <table className="hidden min-w-full text-gray-900 md:table">
            ...
            <tbody className="bg-white">
              {invoices?.map(invoice => (
                <tr
                  key={invoice.id}
                  className="w-full hover:bg-gray-50 border-b py-3 text-sm last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg"
                >
